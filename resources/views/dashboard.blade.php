								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/images/avatar/small/avatar1.webp') }}" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/images/avatar/small/avatar2.webp" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/images/avatar/small/avatar3.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/images/avatar/small/avatar4.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/images/avatar/small/avatar5.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz- -user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/images/avatar/small/avatar6.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/images/avatar/small/avatar7.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/images/avatar/small/avatar8.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/images/avatar/small/avatar9.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/images/avatar/small/avatar10.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{ asset('assets/images/avatar/small/avatar1.webp') }}" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
										<img src="{{ asset('assets/images/avatar/small/avatar2.webp" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                                ...
                                <div class="dz-scroll p-2" style="height: 380px;">
                                    <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                        <div class="d-inline-block">
                                            <img src="{{ asset('assets/images/avatar/small/avatar1.webp') }}" alt="" class="rounded-circle avatar avatar-sm">
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                        <div class="d-inline-block">
                                            <img src="{{ asset('assets/images/avatar/small/avatar2.webp" alt="" class="rounded-circle avatar avatar-sm">
                                        </div>
                                        <div class="clearfix ms-2">
                                            <h6 class="fs-13 mb-0 fw-semibold">Resport created successfully</h6>
                                            <small>29 July 2020 - 02:26 PM</small>
                                    ...
                                    <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                        <div class="d-inline-block">
                                            <img src="{{ asset('assets/images/avatar/small/avatar3.webp" alt="" class="rounded-circle avatar avatar-sm">
                                        </div>
                                        <div class="clearfix ms-2">
                                            <h6 class="fs-13 mb-0 fw-semibold">Dr sultads Send you Photo</h6>
                                            <small>29 July 2020 - 02:26 PM</small>
                                    ...
                                    <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                        <div class="d-inline-block">
                                            <img src="{{ asset('assets/images/avatar/small/avatar4.webp" alt="" class="rounded-circle avatar avatar-sm">
                                        </div>
                                        <div class="clearfix ms-2">
                                            <h6 class="fs-13 mb-0 fw-semibold">Resport created successfully</h6>
                                            <small>29 July 2020 - 02:26 PM</small>
						...
						<div class="card">
							...
							<div class="card-body pb-2 dz-scroll height370 loadmore-content" id="RecentActivityContent">
								<div class="d-flex pb-3 mb-3 border-bottom align-items-end">
									<div class="me-3">
										<img class="rounded-circle" alt="image" width="50" src="{{ asset('assets/images/avatar/1.webp">
									</div>
									<div>
								...
								<div class="d-flex pb-3 mb-3 border-bottom align-items-end">
									<div class="me-3">
										<img class="rounded-circle" alt="image" width="50" src="{{ asset('assets/images/avatar/2.webp">
									</div>
									<div>
								...
								<div class="d-flex pb-3 mb-3 border-bottom align-items-end">
									<div class="me-3">
										<img class="rounded-circle" alt="image" width="50" src="{{ asset('assets/images/avatar/3.webp">
									</div>
									<div>
								...
								<div class="d-flex pb-3 mb-3 border-bottom align-items-end">
									<div class="me-3">
										<img class="rounded-circle" alt="image" width="50" src="{{ asset('assets/images/avatar/4.webp">
									</div>
									<div>
