                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-titles">
                            <h4 class="text-black">Admin Dashboard</h4>
                            ...
                            <div class="card-body">
                                <div class="media ai-icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h4 class="mb-0">PKR {{ number_format($paidToday ?? 0, 2) }}</h4>
                                        <p class="mb-0"><small class="text-muted">INV: {{ $invoicesToday ?? 0 }}</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-stat card">
                            <div class="card-body">
                                <div class="media ai-icon">
                                    ...
                                    <div class="media-body">
                                        <p class="mb-1">WEEK</p>
                                        <h4 class="mb-0">PKR {{ number_format($paidThisWeek ?? 0, 2) }}</h4>
                                        <p class="mb-0"><small class="text-muted">INV: {{ $invoicesThisWeek ?? 0 }}</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="media ai-icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h4 class="mb-0">PKR {{ number_format($paidThisMonth ?? 0, 2) }}</h4>
                                        <p class="mb-0"><small class="text-muted">INV: {{ $invoicesThisMonth ?? 0 }}</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('admin.customers.index') }}" class="btn btn-primary">
                                    <i class="flaticon-381-user-8 me-2"></i>Manage Customers
                                </a>
                            </div>
                        </div>
                    </div>
