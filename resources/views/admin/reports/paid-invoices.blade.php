...
<html lang="en">
<head>
    <title>Paid Invoices - {{ config('app.name') }}</title>
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-titles">
                            <h4 class="text-black">Paid Invoices</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('admin.reports.paid-invoices') }}" class="row g-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end">
                                        ...
                                        <a href="{{ route('admin.reports.paid-invoices') }}" class="btn btn-secondary">Clear</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Paid Invoices ({{ $invoices->total() }})</h4>
                            </div>
                            <div class="card-body">
                                @if($invoices->count() > 0)
                                ...
                                @else
                                    <div class="alert alert-info">
                                        <p class="mb-0">No paid invoices found.</p>
                                    </div>
                                @endif
                            </div>
                        </div>
