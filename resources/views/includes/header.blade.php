                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item">
                        <select class="selectpicker form-select i18n-select" id="langSwitcher">
                            <option value="en_GB" title="English" data-content="<img src='{{ asset('assets/images/flags/gb-eng.svg') }}' alt=''> English">English</option>
                            <option value="pt_BR" title="Portuguese" data-content="<img src='{{ asset('assets/images/flags/pt.svg') }}' alt=''> Português">Português</option>
                            <option value="fr_FR" title="French" data-content="<img src='{{ asset('assets/images/flags/fr.svg') }}' alt=''> Français">Français</option>
                            <option value="de_DE" title="German" data-content="<img src='{{ asset('assets/images/flags/de.svg') }}' alt=''> Deutsch">Deutsch</option>
                            <option value="it_IT" title="Italian" data-content="<img src='{{ asset('assets/images/flags/it.svg') }}' alt=''> Italiano">Italiano</option>
                            <option value="jp_JP" title="Japanese" data-content="<img src='{{ asset('assets/images/flags/jp.svg') }}' alt=''> 日本語">日本語</option>
                            <option value="es_ES" title="Spanish" data-content="<img src='{{ asset('assets/images/flags/es.svg') }}' alt=''> Español">Español</option>
                            <option value="ar_TN" title="Arabic" data-content="<img src='{{ asset('assets/images/flags/arab.svg') }}' alt=''> العربية">العربية</option>
                            <option value="tr_TR" title="Turkish" data-content="<img src='{{ asset('assets/images/flags/tr.svg') }}' alt=''> Türkçe">Türkçe</option>
                        </select>
                    </li>
                    <li class="nav-item dropdown notification_dropdown">
