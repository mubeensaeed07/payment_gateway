...
{
    /**
     * Display external provider logs with search functionality
     */
    public function index(Request $request)
    {
        $adminId = Auth::id();
        
        // Build query - only show logs for this admin's external provider
        $query = ExternalProviderLog::where('admin_id', $adminId)
