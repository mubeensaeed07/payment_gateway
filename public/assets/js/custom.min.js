		...
		if(jQuery(".dz-theme-mode").length>0) {
			jQuery('.dz-theme-mode').on('click',function(){
				...
				if(jQuery(this).hasClass('active')){
					...
					jQuery(".nav-header .logo-abbr").attr("src", "./images/logo-white.avif");
					jQuery(".nav-header .logo-compact").attr("src", "images/logo-text-white.avif");
					jQuery(".nav-header .brand-title").attr("src", "images/logo-text-white.avif");
					
					setCookie('logo_src', './images/logo-white.avif');
					setCookie('logo_src2', 'images/logo-text-white.avif');
				}else{
					jQuery('body').attr('data-theme-version','light');
					setCookie('version', 'light');
					jQuery('#theme_version').val('light');	
					jQuery(".nav-header .logo-abbr").attr("src", "./images/logo.avif");
					jQuery(".nav-header .logo-compact").attr("src", "images/logo-text.avif");
					jQuery(".nav-header .brand-title").attr("src", "images/logo-text.avif");
					
					setCookie('logo_src', './images/logo.avif');
					setCookie('logo_src2', 'images/logo-text.avif');				
				}
