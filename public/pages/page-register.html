                    ...
                    <div class="auth-form">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <a href="index.html"><img class="logo-auth" src="assets/images/logo-full.avif" width="200" alt=""></a>
                            </div>
                            ...
                            <div class="new-account mt-3">
                                <p>Already have an account? <a class="text-primary" href="pages/page-login.html">Sign in</a></p>
                            </div>
                        </div>
                    </div>
                </div>
